...
```{r}
#| label: datasets-chickweight-overview
# 载入数据集
data(ChickWeight)
...
```{r}
#| label: datasets-plantgrowth-overview
# 载入数据集
data(PlantGrowth)
...
```{r}
#| label: fig-datasets-npk-interaction-NP
#| fig-cap: "NPK数据集中N×P交互作用图"
#| fig-width: 5
#| fig-height: 3.5
interaction.plot(
...
```{r}
#| label: fig-datasets-npk-interaction-NK
#| fig-cap: "NPK数据集中N×K交互作用图"
#| fig-width: 5
#| fig-height: 3.5
# N × K 交互作用
interaction.plot(
...
```{r}
#| label: fig-datasets-npk-interaction-PK
#| fig-cap: "NPK数据集中P×K交互作用图"
#| fig-width: 5
#| fig-height: 3.5
# P × K 交互作用
interaction.plot(
...
```{r}
#| label: datasets-chickweight-head
head(ChickWeight)
```
...
```{r}
#| label: datasets-chickweight-str
str(ChickWeight)
```
...
```{r}
#| label: fig-chick-growth
#| fig-cap: "ChickWeight 生长轨迹（个体曲线 + 饲料均值）"
#| fig-width: 8
#| fig-height: 5
...
```{r}
#| label: datasets-chickweight-nlslist
# 按小鸡个体分别拟合逻辑斯蒂曲线
fm1 <- nlsList(
...
```{r}
#| label: datasets-chickweight-nlme
# 混合效应非线性模型：固定效应 + 随机效应
fm2 <- nlme(
...
```{r}
#| label: datasets-chickweight-predict
# 提取群体平均预测值（固定效应）
...
```{r}
#| label: fig-chick-fixed-pred
#| fig-cap: "nlme 模型对群体平均生长曲线的拟合"
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| label: fig-chick-indiv-pred
#| fig-cap: "nlme 模型对个体生长曲线的拟合"
#| fig-width: 6
#| fig-height: 4
...
```{r}
#| label: datasets-plantgrowth-str
# 载入数据集
data(PlantGrowth)
...
```{r}
#| label: fig-plantgrowth-boxplot
#| fig-cap: "PlantGrowth 不同组别植物干重分布"
#| fig-width: 3.5
#| fig-height: 3
...
```{r}
#| label: datasets-plantgrowth-aov
# 构建单因素方差分析模型
...
```{r}
#| label: datasets-plantgrowth-levene
library(car)
...
```{r}
#| label: datasets-plantgrowth-shapiro
...
```{r}
#| label: datasets-plantgrowth-tukey
...
```{r}
#| label: fig-plantgrowth-pubr
#| fig-cap: "PlantGrowth 组间比较（带显著性标记）"
#| fig-width: 4
#| fig-height: 3.5
